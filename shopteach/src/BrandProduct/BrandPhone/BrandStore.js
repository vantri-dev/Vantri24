      ...
      <div className=" col-span-1   bg-[#cdcfd2] min-h-[100px] w-[90%] rounded">
        ...
        <div className="w-[70px] h-[70px] relative mx-3 mt-3">
          ...
          <div className=" px-1 pt-2">
            <span className=" font-mono text-[1.099rem] text-white">Apple Flagship Store</span>
            <p className=" text-[0.85rem]  text-slate-100">Online 15 phút trước</p>
          </div>
        </div>
        <div>
            {
          ...
          <div  onClick={hanldeFollowed} className="flex justify-center py-[1px] mx-8
           rounded
...
<div  onClick={hanldeFollowed}  className={`flex justify-center py-[8px] mx-8 rounded
