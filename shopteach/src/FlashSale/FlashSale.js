...
export default function FlashSale() {
  ...
  return (
    <div className="pr-[100px]  pl-[90px]  w-full  bg-gray-100 relative ">
      ...
      <div className=" sticky top-[80px] w-full bg-white py-[16px] ">
        <ul
          id="sale"
          className="flex items-center gap-4   overflow-x-scroll scroll-smooth  whitespace-nowrap"
        ...
        >
          ...
          <li key={i} className="  white border   rounded cursor-pointer hover:border-violet   ease-in-out  duration-300">
