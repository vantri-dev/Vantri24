    ...
    <div className=" w-full  h-screen">
      <div className="w-full h-[70.2%]  bg-white rounded">
        <div className="border-b">
          <nav className="flex  pt-9 pb-2 justify-around ">
        ...
        <ul>
          <li className={tabs === 0 ? "block w-full max-h-screen  " : "hidden"}>
            <div className="grid grid-cols-2 gap-3 mt-3 px-3">
              <div className=" col-span-1 grid grid-cols-3  bg-white border shadow-md w-full h-[120px] rounded relative">
                ...
                <div className="col-span-2 ">
                  <div className="grid grid-cols-3 py-2  px-1">
                    <span className=" col-span-2 text-[1.05rem] text-textword ">
                      Giảm 50% cho đơn tối thiểu 550k
                    </span>
                    <Link
                      to="/"
              ...
              <div class="w-5 h-2.5 rounded-bl-full rounded-br-full bg-white absolute left-[145px] top-[82.5px] border border-t-transparent "></div>
              <div class="w-5 h-2.5 rounded-tl-full rounded-tr-full bg-white absolute left-[145px] top-[192.5px] border border-b-transparent "></div>

              <div
                class="w-0 h-0 top-[110px] left-[3.8px] absolute
    border-t-[5px] border-t-transparent
    border-r-[9px] border-r-fuchsia-300
    border-b-[8px] border-b-transparent
    "
              ></div>
              <div className=" absolute bg-fuchsia-400 w-[10.8%] top-[90px] left-1  pb-[2px] rounded-sm">
